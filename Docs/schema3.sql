...
CREATE INDEX "idx_products_description" ON "public"."products" USING "gin" ("description" "public"."gin_trgm_ops");



CREATE INDEX "idx_products_name" ON "public"."products" USING "gin" ("name" "public"."gin_trgm_ops");
...
CREATE POLICY "Enable all access for authenticated users" ON "public"."product_categories" TO "authenticated" USING (true) WITH CHECK (true);
